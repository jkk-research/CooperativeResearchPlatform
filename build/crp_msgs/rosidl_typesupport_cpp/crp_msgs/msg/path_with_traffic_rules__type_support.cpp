...
static const _PathWithTrafficRules_type_support_symbol_names_t _PathWithTrafficRules_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crp_msgs, msg, PathWithTrafficRules)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crp_msgs, msg, PathWithTrafficRules)),
  }
};
...
{
  return &::crp_msgs::msg::rosidl_typesupport_cpp::PathWithTrafficRules_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crp_msgs, msg, PathWithTrafficRules)() {
  return get_message_type_support_handle<crp_msgs::msg::PathWithTrafficRules>();
}
