...
#include "crp_msgs/msg/detail/traffic_rule__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose_with_covariance__functions.h"  // stop_pose
...
using _TrafficRule__ros_msg_type = crp_msgs__msg__TrafficRule;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrafficRule__ros_msg_type * ros_message = static_cast<const _TrafficRule__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: lane_edge_type_left
  {
    cdr << ros_message->lane_edge_type_left;
  }

  // Field name: lane_edge_type_right
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrafficRule__ros_msg_type * ros_message = static_cast<_TrafficRule__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TrafficRule__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crp_msgs__msg__TrafficRule(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crp_msgs__msg__TrafficRule;
    is_plain =
      (
...
static size_t _TrafficRule__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crp_msgs__msg__TrafficRule(
...
static message_type_support_callbacks_t __callbacks_TrafficRule = {
  "crp_msgs::msg",
  "TrafficRule",
...
static rosidl_message_type_support_t _TrafficRule__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrafficRule,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crp_msgs, msg, TrafficRule)() {
  return &_TrafficRule__type_support;
}
