...
#include "crp_msgs/msg/detail/ego__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const crp_msgs::msg::Ego & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crp_msgs::msg::Ego;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crp_msgs::msg::Ego *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crp_msgs::msg::Ego *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Ego__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crp_msgs::msg::Ego *>(
...
static size_t _Ego__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ego(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Ego__callbacks = {
  "crp_msgs::msg",
  "Ego",
  _Ego__cdr_serialize,
...
static rosidl_message_type_support_t _Ego__handle = {
...
{
  return &crp_msgs::msg::typesupport_fastrtps_cpp::_Ego__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crp_msgs, msg, Ego)() {
  return &crp_msgs::msg::typesupport_fastrtps_cpp::_Ego__handle;
}
