...
#include "crp_msgs/msg/detail/path_with_traffic_rules__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_planning_msgs::msg::PathWithLaneId &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const crp_msgs::msg::TrafficRule &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const crp_msgs::msg::PathWithTrafficRules & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  crp_msgs::msg::PathWithTrafficRules & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: path
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PathWithLaneId(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: traffic_rules
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        crp_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficRule(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = crp_msgs::msg::PathWithTrafficRules;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crp_msgs::msg::PathWithTrafficRules *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crp_msgs::msg::PathWithTrafficRules *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PathWithTrafficRules__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crp_msgs::msg::PathWithTrafficRules *>(
...
static size_t _PathWithTrafficRules__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PathWithTrafficRules(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PathWithTrafficRules__callbacks = {
  "crp_msgs::msg",
...
static rosidl_message_type_support_t _PathWithTrafficRules__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PathWithTrafficRules__callbacks,
...
{
  return &crp_msgs::msg::typesupport_fastrtps_cpp::_PathWithTrafficRules__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crp_msgs, msg, PathWithTrafficRules)() {
  return &crp_msgs::msg::typesupport_fastrtps_cpp::_PathWithTrafficRules__handle;
}
