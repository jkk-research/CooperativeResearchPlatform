...
private:
    ...
    void localPathCallback(const crp_msgs::msg::PathWithTrafficRulesArray::SharedPtr msg);
    ...
    rclcpp::Subscription<crp_msgs::msg::PathWithTrafficRulesArray>::SharedPtr        m_sub_possiblePaths_;
