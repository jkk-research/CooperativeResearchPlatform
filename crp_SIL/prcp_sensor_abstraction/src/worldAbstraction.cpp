...
crp::vil::WorldAbstraction::WorldAbstraction() : Node("world_abstraction")
{
...
void crp::vil::WorldAbstraction::staticMapFromFileCallback(const autoware_map_msgs::msg::LaneletMapBin::SharedPtr msg)
{
    m_pub_staticMap_->publish(*msg);
}


void crp::vil::WorldAbstraction::staticMapFromServerCallback(const autoware_map_msgs::msg::LaneletMapBin::SharedPtr msg)
{
    // TODO
    return;
}
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<crp::vil::WorldAbstraction>());
    rclcpp::shutdown();
    return 0;
}
