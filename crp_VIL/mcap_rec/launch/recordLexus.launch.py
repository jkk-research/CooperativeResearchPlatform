...
DeclareLaunchArgument("tag", description="a tag to the recorded file", default_value="crp"),
...
def exit_process_function(_launch_context):
    ...
    print("")
    print("ros2 bag info /mnt/bag/" + date_ + "_crp/"+ tag_ +"_" + date_and_time_)
    print("~/mcap/mcap info /mnt/bag/" + date_ + "_crp/"+ tag_ +"_" + date_and_time_ + "/" + tag_ +"_" + date_and_time_ + "_0.mcap")
