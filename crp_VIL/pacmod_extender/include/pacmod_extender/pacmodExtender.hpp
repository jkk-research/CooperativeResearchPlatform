...
private:
    ...
    void steeringCallback(const pacmod3_msgs::msg::SystemRptFloat::SharedPtr msg);
    void blinkerCallback(const pacmod3_msgs::msg::SystemRptInt::SharedPtr msg);
    ...
    rclcpp::Subscription<pacmod3_msgs::msg::SystemRptFloat>::SharedPtr m_sub_steering_;
    rclcpp::Subscription<pacmod3_msgs::msg::SystemRptInt>::SharedPtr   m_sub_blinker_;
    ...
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr                         m_pub_steeringWheelRate_;
    rclcpp::Publisher<std_msgs::msg::Int8>::SharedPtr                            m_pub_blinker_;

    PacmodDefinitions pacmodDefinitions;

    rclcpp::TimerBase::SharedPtr m_timer_;
    geometry_msgs::msg::TwistWithCovarianceStamped m_twistWithCovariance;
    pacmod3_msgs::msg::SystemRptFloat m_prevSteeringRpt;
    pacmod3_msgs::msg::LinearAccelRpt m_linAccel;
    std_msgs::msg::Float32 m_steeringRate;
    float m_prevSteeringRate = 0.0f;
