...
The platform can be used in a docker container. The docker container is built on top of the autoware docker (ghcr.io/autowarefoundation/autoware:latest-devel-cuda). The autoware docker can be built using the script inside the autoware repository. Autoware and CRP should be built for the same platform type (amd64/arm64).
\newline
